...
Moving away from the traditional 12-col flex grid, the deciding question is: *does the layout structure define the content layout, or does the content determine the layout?*
