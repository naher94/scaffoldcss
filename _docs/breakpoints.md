...
<p>Breakpoints are exposed as a SCSS mixin. Responsive utility classes use a mobile-first prefix convention.</p>
...
<p>Unprefixed classes apply at all sizes; prefixed classes apply at that breakpoint and above.</p>
